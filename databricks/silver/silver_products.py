...
silver_products = (
    spark.table("retail_lakehouse.bronze.dim_product_pool")
...
(
    ...
    .option("path", "gs://lakehouse-analytics-raw-bronze/silver/products")
    .saveAsTable("retail_lakehouse.silver.products")
)
